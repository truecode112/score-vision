...
CHALLENGE_INTERVAL = timedelta(minutes=int(os.getenv("CHALLENGE_INTERVAL_MINUTES", "1")))
CHALLENGE_TIMEOUT = timedelta(minutes=int(os.getenv("CHALLENGE_TIMEOUT_MINUTES", "60")))
DB_PATH = Path(os.getenv("DB_PATH", "validator.db"))
WEIGHTS_INTERVAL = timedelta(minutes=int(os.getenv("WEIGHTS_INTERVAL_MINUTES", "2")))
VALIDATION_DELAY = timedelta(minutes=int(os.getenv("VALIDATION_DELAY_MINUTES", "2")))
